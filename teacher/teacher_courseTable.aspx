<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teacher_courseTable.aspx.cs" Inherits="teacher_teacher_courseTable" %>
...
<body style="margin-top: 0px; margin-bottom: 0px; margin-right:0px; margin-left:0px" class="css">
    ...
    <div>
        <table style="width: 1003px; height: 1500px" border="0" cellpadding="0" cellspacing="0" class="css">
            ...
            <tr style="height: 1315px">
                <td style="vertical-align: top; text-align: center; background-color: #dee9f9;" colspan="3">
                    <table border="1"  cellpadding="0" bordercolordark="#003399" bordercolorlight="#6a82dd"
                        cellspacing="0" class="css" style="width: 995px; height: 50px">
                        <tr style="height: 25px">
                            <td style="width: 263px; background-color: #e4ecf3; text-align: left">
                                &nbsp;
                                教工编号：<asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></td>
                            <td style="width: 370px; background-color: #e4ecf3; text-align: left">
                                &nbsp;&nbsp; 姓名：<asp:Label ID="Label3" runat="server" Text="Label"></asp:Label></td>
                            <td style="width: 370px; background-color: #e4ecf3; text-align: left">
                                &nbsp; &nbsp;学院：<asp:Label ID="Label5" runat="server" Text="Label"></asp:Label></td>
                        </tr>
                        <tr style="height: 25px">
                            <td style="width: 263px; background-color: #e4ecf3; text-align: left">
                                &nbsp;
                                职称：<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></td>
                            <td style="width: 370px; background-color: #e4ecf3; text-align: left">
                                &nbsp; &nbsp;学年：<asp:DropDownList ID="DropDownList2" runat="server" Width="100px">
                                </asp:DropDownList></td>
                            <td style="width: 370px; background-color: #e4ecf3; text-align: left">
                                &nbsp;&nbsp; 学期： &nbsp;
