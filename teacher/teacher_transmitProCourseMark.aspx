<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teacher_transmitProCourseMark.aspx.cs" Inherits="teacher_teacher_transmitProCourseMark" %>
                ...
                <td style="vertical-align: top; background-color: #dee9f9; text-align: left" colspan="3">
                    <table border="0" cellpadding="0" cellspacing="0" class="css" style="width: 1003px;
                        ...
                        <tr style="height: 25px">
                            ...
                            <td style="width: 334px">
                                &nbsp;&nbsp;
                                学年：<asp:DropDownList ID="studyYear" runat="server"  Width="87px">
                                </asp:DropDownList>
                            </td>
                            <td style="width: 334px">
                                &nbsp; &nbsp;
                        ...
                        <tr style="height: 25px">
                            <td style="width: 334px">
                                &nbsp;&nbsp; 课程性质：<asp:DropDownList ID="courseProperty" runat="server" AutoPostBack="True"
                                    Width="80px" OnSelectedIndexChanged="courseProperty_SelectedIndexChanged">
                            ...
                            <td style="width: 334px">
                                &nbsp;&nbsp; 班级：<asp:DropDownList ID="adminClass" runat="server" Width="194px" AutoPostBack="True" OnSelectedIndexChanged="adminClass_SelectedIndexChanged">
                                </asp:DropDownList></td>
                            <td style="width: 334px">
                                &nbsp;
                                </td>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="课程代码">
                                        <ItemTemplate>
                                        <asp:Label id="Label1" runat="server" ForeColor="#003399" Text="Label"></asp:Label>
                                        </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                        <asp:Label id="Label3" runat="server" ForeColor="#003399" Text="Label"></asp:Label>
                                        </ItemTemplate>
                                        </asp:TemplateField>
