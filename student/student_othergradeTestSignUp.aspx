<%@ Page Language="C#" AutoEventWireup="true" CodeFile="student_othergradeTestSignUp.aspx.cs" Inherits="student_student_othergradeTestSignUp" %>
...
<body style="margin-top: 0px; margin-bottom: 0px; margin-right:0px; margin-left:0px" class="css">
                    ...
                    <table border="1" cellpadding="0" cellspacing="0"  bordercolordark="#003399" bordercolorlight="#6a82dd" style="width: 995px; height: 545px; text-align: left; vertical-align: top; background-color: #dee9f9;">
                        ...
                        <tr style="height: 120px">
                            <td style="background-color: #e4ecf3" colspan="3">
                                ...
                                &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;<asp:Button ID="Button1" runat="server" class=btn3_mouseout onmouseover="this.className='btn3_mouseover'"
 ...
 onmousedown="this.className='btn3_mousedown'"
  onmouseup="this.className='btn3_mouseup'"/>
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                <asp:Button ID="Button4" runat="server" class=btn3_mouseout onmouseover="this.className='btn3_mouseover'"
 onmouseout="this.className='btn3_mouseout'"
 onmousedown="this.className='btn3_mousedown'"
  onmouseup="this.className='btn3_mouseup'" Text="关  闭" /></td>
                        </tr>
                        <tr style="height: 150px">
                            <td colspan="3" style="vertical-align: top; text-align: left; color: red;"> &nbsp; 学生当前报名情况：<asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BorderColor="#003399" CellPadding="3" Width="700px" BackColor="White">
                                <HeaderStyle BackColor="#003399" ForeColor="White" />
                                <AlternatingRowStyle BackColor="#EFEFFF" />
                                <Columns>
                                    <asp:BoundField DataField="testName" HeaderText="考试名称" />
