<%@ Page Language="C#" AutoEventWireup="true" CodeFile="student_tiptopMark.aspx.cs" Inherits="student_student_tiptopMark" %>

<%@ Register Src="../student/student_main.ascx" TagName="student_main" TagPrefix="uc1" %>
<%@ Register Src="../student/foot.ascx" TagName="foot" TagPrefix="uc2" %>
    ...
    <div>
        <table style="width: 1003px; height: 621px" border="0" cellpadding="0" cellspacing="0" class="css">
            ...
            <td colspan="9" style="height: 25px; background-image: url(../image/system/main_top_bg.gif); text-align: left; color: black;">
                &nbsp;&nbsp; 信息查询→考试成绩查询→最高成绩查询</td>
            </tr>
            <tr style="height: 25px;">
                <td style="height: 25px;width: 127px; text-align: center; background-color: #dee9f9;">
                    学年&nbsp;
                    <asp:DropDownList ID="studyYear" runat="server" CssClass="css"  Width="73px" AppendDataBoundItems="True">
                    </asp:DropDownList>
                    &nbsp;
                </td>
                <td style="height: 25px;width: 127px; text-align: center; background-color: #dee9f9;">
  ...
  onmouseup="this.className='btn3_mouseup'" Width="127px" /></td>
            ...
            <tr>
                <td colspan="9" style="height: 410px; vertical-align: top; text-align: left; background-color: #dee9f9;">
                    <table style="width: 1003px; height: 400px" border="1" bordercolordark="#003399" bordercolorlight="#6a82dd" cellpadding="0" cellspacing="0" class="css">
                        <tr>
                        ...
                        <tr>
                            <td colspan="3" style="height:325px; vertical-align: top; text-align: left; background-color: #dee9f9;">
                                &nbsp;&nbsp;
                                <asp:Label ID="search" runat="server" Text="请输入你所要搜索信息的条件：" Font-Bold="False" Font-Size="11pt" ForeColor="Red"></asp:Label>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderColor="#3366CC" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" Font-Size="12px" HorizontalAlign="Center" Width="1003px" BackColor="White">
