<%@ Page Language="C#" AutoEventWireup="true" CodeFile="student_pastyearMark.aspx.cs" Inherits="student_student_pastyearMark" %>
    ...
    <div>
        <table style="width: 1003px; height: 620px" border="0" cellpadding="0" cellspacing="0" class="css">
            ...
            <td colspan="9" style="height: 25px; background-image: url(../image/system/main_top_bg.gif); text-align: left; color: black;">
                &nbsp;&nbsp; 信息查询→考试成绩查询→历年成绩查询</td>
            </tr>
            <tr style="height: 25px;">
                <td style="height: 25px;width: 127px; text-align: center; background-color: #dee9f9;">
                    学年&nbsp;
                    <asp:DropDownList ID="studyYear" runat="server" AppendDataBoundItems="True" CssClass="css"
            ...
            <tr>
                <td colspan="9" style="height: 410px; vertical-align: top; text-align: left; background-color: #dee9f9;">
                    <table style="width: 1003px; height: 400px" border="1" bordercolordark="#003399" bordercolorlight="#6a82dd" cellpadding="0" cellspacing="0" class="css">
                        ...
                        <tr style="height:25px">
                            <td style="width: 263px; background-color: #dee9f9; height: 25px;">
                                &nbsp;&nbsp;
