<%@ Page Language="C#" AutoEventWireup="true" CodeFile="info_collegePunishInfoResult.aspx.cs" Inherits="manager_sysManager_infomationStat_info_collegePunishInfoResult" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title> 信息统计→查找学生处罚信息结果如下：</title>
            ...
            <tr style="height: 545px">
                <td colspan="3" style="vertical-align: top; text-align: left">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        BackColor="White" BorderColor="White" CellPadding="4" OnPageIndexChanging="GridView1_PageIndexChanging"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="punishCode" HeaderText="处罚编号">
                                <ItemStyle Width="30px" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="punishName" HeaderText="处罚名称" >
                                <ItemStyle Width="50px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="punishUnit" HeaderText="处罚单位" >
                                <ItemStyle Width="160px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="punishStudyYear" HeaderText="处罚学年" >
                                <ItemStyle Width="30px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="punishSemester" HeaderText="处罚学期" >
                                <ItemStyle Width="30px" />
                            </asp:BoundField>
                            <asp:CommandField EditText="详细信息" HeaderText="详细信息" ShowEditButton="True">
                                <ItemStyle ForeColor="Red" />
                            </asp:CommandField>
                            <asp:CommandField HeaderText="删除处罚" ShowDeleteButton="True">
                                <ItemStyle ForeColor="Red" />
                            </asp:CommandField>
                        </Columns>
