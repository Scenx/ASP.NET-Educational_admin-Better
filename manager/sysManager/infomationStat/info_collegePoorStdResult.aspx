<%@ Page Language="C#" AutoEventWireup="true" CodeFile="info_collegePoorStdResult.aspx.cs" Inherits="manager_sysManager_infomationStat_info_collegePoorStdResult" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>信息统计→查找贫困生信息结果如下：</title>
                ...
                <td colspan="3" style="vertical-align: top; text-align: left">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="totalPopulation" HeaderText="家庭人口" />
                            <asp:BoundField DataField="yearIncome" HeaderText="年收入" />
                            <asp:BoundField DataField="averageIncome" HeaderText="平均收入" />
                            <asp:BoundField DataField="incomeSource" HeaderText="收入来源" />
