<%@ Page Language="C#" AutoEventWireup="true" CodeFile="info_collegeScholarshipInfoResult.aspx.cs" Inherits="manager_sysManager_infomationStat_info_collegeScholarshipInfoResult" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>信息统计→查找获得奖学金的学生信息结果如下：</title>
                ...
                <td colspan="3" style="vertical-align: top; text-align: left">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="scholarCode" HeaderText="奖学金编号">
                                <ItemStyle Width="30px" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="scholarName" HeaderText="奖学金名称">
                                <ItemStyle Width="50px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="scholarUnit" HeaderText="奖学金单位">
                                <ItemStyle Width="160px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="scholarStudyYear" HeaderText="奖学金学年">
                                <ItemStyle Width="40px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="scholarSemester" HeaderText="奖学金学期">
                                <ItemStyle Width="40px" />
                            </asp:BoundField>
