<%@ Page Language="C#" AutoEventWireup="true" CodeFile="std_findGradeTestSignUpInfoResult.aspx.cs" Inherits="manager_sysManager_studentManage_std_findGradeTestSignUpInfoResult" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>学生管理→查找学生四六级考试报名信息结果如下</title>
            ...
            <tr style="height: 570px">
                <td colspan="3" style="vertical-align: top; text-align: left">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        BackColor="White" BorderColor="White" CellPadding="4" Font-Size="12px" OnPageIndexChanging="GridView1_PageIndexChanging"
                        OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting"
                        OnRowEditing="GridView1_RowEditing" PageSize="12" Width="900px" CssClass="css" OnRowCommand="GridView1_RowCommand" OnRowCreated="GridView1_RowCreated">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="signupDate" HeaderText="报名日期" />
                            <asp:BoundField DataField="testName" HeaderText="考试名称" />
                            <asp:BoundField DataField="signupYear" HeaderText="报名学年" />
                            <asp:BoundField DataField="signupSemester" HeaderText="报名学期" />
                            <asp:TemplateField HeaderText="报名缴费">
                            <ItemTemplate>
                                       <asp:LinkButton ID="LinkButton1" runat="server" CommandName="LBClick" ForeColor="Red" >缴费</asp:LinkButton>
