<%@ Page Language="C#" AutoEventWireup="true" CodeFile="std_addStudentBasicInfo.aspx.cs" Inherits="manager_sysManager_studentManage_std_addStudentBasicInfo" %>
                    ...
                    <table border="1" bordercolordark="#003399" bordercolorlight="#6a82dd" cellspacing="0"
                        ...
                        <tr>
                            ...
                            <td style="width: 184px; height: 25px; background-color: #dee9f9">
                                &nbsp;
                                <asp:TextBox ID="studyNumber" runat="server" Width="120px"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="学号不能为空！" ControlToValidate="studyNumber">*</asp:RequiredFieldValidator></td>
                            ...
                            <td style="width: 183px; height: 25px; background-color: #dee9f9">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage="学生证号不能为空！" ControlToValidate="stdproveCode">*</asp:RequiredFieldValidator></td>
                        ...
                        <tr>
                            ...
                            <td style="width: 184px; height: 25px; background-color: #dee9f9">
                                &nbsp;
                                <asp:TextBox ID="IDcardNumber" runat="server" Width="120px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="身份证号不能为空！" ControlToValidate="IDcardNumber">*</asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="IDcardNumber"
                                    ErrorMessage="身份证号格式不对！" ValidationExpression="\d{17}[\d|X]|\d{15}">*</asp:RegularExpressionValidator>
                            </td>
                            <td style="width: 143px; height: 25px; background-color: #e4ecf3">
                                &nbsp; 培养方向：</td>
                            <td style="width: 183px; height: 25px; background-color: #dee9f9">
                        ...
                        <tr>
                            ...
                            <td style="width: 184px; height: 25px; background-color: #dee9f9">
                                &nbsp;
                                <asp:TextBox ID="studentName" runat="server" Width="120px"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="姓名不能为空！" ControlToValidate="studentName">*</asp:RequiredFieldValidator>
                            </td>
                            <td style="width: 143px; height: 25px; background-color: #e4ecf3">
                                &nbsp; 专业方向：</td>
                            <td style="width: 183px; height: 25px; background-color: #dee9f9">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ErrorMessage="专业方向不能为空！" ControlToValidate="specialityDirection">*</asp:RequiredFieldValidator></td>
                            <td style="width: 155px; height: 25px; background-color: #e4ecf3">
                                &nbsp; 父亲姓名：</td>
                            <td style="width: 209px; height: 25px; background-color: #dee9f9">
                                &nbsp;
                        ...
                        <tr>
                            ...
                            <td style="width: 183px; height: 25px; background-color: #dee9f9">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ErrorMessage="入学日期不能为空！" ControlToValidate="entranceDate">*</asp:RequiredFieldValidator>
                        ...
                        <tr>
                            ...
                            <td style="width: 184px; height: 25px; background-color: #dee9f9">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="教学班不能为空！" ControlToValidate="teachedClass">*</asp:RequiredFieldValidator></td>
                            <td style="width: 143px; height: 25px; background-color: #e4ecf3">
                                &nbsp; 录检表码：</td>
                            <td style="width: 183px; height: 25px; background-color: #dee9f9">
                                &nbsp;
                        ...
                        <tr>
                            ...
                            <td style="width: 184px; height: 25px; background-color: #dee9f9">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="行政班不能为空！" ControlToValidate="adminClass">*</asp:RequiredFieldValidator></td>
                            <td style="width: 143px; height: 25px; background-color: #e4ecf3">
                                &nbsp; 特长：</td>
                            <td style="width: 183px; height: 25px; background-color: #dee9f9">
                                &nbsp;
