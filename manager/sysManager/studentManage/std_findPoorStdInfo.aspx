<%@ Page Language="C#" AutoEventWireup="true" CodeFile="std_findPoorStdInfo.aspx.cs" Inherits="manager_sysManager_studentManage_std_findPoorStdInfo" %>
                   ...
                   <table border="1" bordercolordark="#003399" bordercolorlight="#6a82dd" cellpadding="0"
                        ...
                        <tr style="height: 25px">
                            ...
                            <td style="width: 402px">
                                <asp:CheckBox ID="IDcardNumber1" runat="server" Text="身份证号：" /><asp:TextBox ID="IDcardNumber" runat="server" Width="120px"></asp:TextBox></td>
                        ...
                        <tr style="height: 25px">
                            ...
                            <td style="width: 402px">
                                <asp:CheckBox ID="college1" runat="server" Checked="True" Enabled="False" Text="学生学院：" /><asp:DropDownList ID="college" runat="server" AutoPostBack="True"  OnSelectedIndexChanged="college_SelectedIndexChanged"
                                    Width="209px">
                                    <asp:ListItem></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td style="width: 282px">
                                <asp:CheckBox ID="speciality1" runat="server" Text="学生专业：" /><asp:DropDownList ID="speciality" runat="server" Width="112px">
                                </asp:DropDownList></td>
                        </tr>
                        <tr style="height: 25px">
