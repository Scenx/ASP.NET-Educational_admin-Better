<%@ Page Language="C#" AutoEventWireup="true" CodeFile="std_findStudentUserInfo.aspx.cs" Inherits="manager_sysManager_studentManage_std_findStudentUserInfo" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>学生管理→学生信息管理→查找学生用户信息</title>
