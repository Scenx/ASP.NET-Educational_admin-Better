<%@ Page Language="C#" AutoEventWireup="true" CodeFile="std_findChooseCourseInfoResult.aspx.cs" Inherits="manager_sysManager_studentManage_std_findChooseCourseInfoResult" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>学生管理→查找学生选课信息结果：</title>
            ...
            <tr style="height: 545px">
                <td colspan="3" style="vertical-align: top; text-align: left">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        OnRowEditing="GridView1_RowEditing" PageSize="12" Width="900px" CssClass="css">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="courseName" HeaderText="选课名称" />
                            <asp:BoundField DataField="teacherName" HeaderText="教师名称" />
                            <asp:BoundField DataField="teacherCode" HeaderText="教师编号" />
                            <asp:BoundField DataField="chooseDate" HeaderText="选课日期" />
                            <asp:BoundField DataField="courseStudyYear" HeaderText="选课学年" />
                            <asp:BoundField DataField="courseSemester" HeaderText="选课学期" />
