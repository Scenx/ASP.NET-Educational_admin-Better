<%@ Page Language="C#" AutoEventWireup="true" CodeFile="std_findStudentBasicInfoResult.aspx.cs" Inherits="manager_sysManager_studentManage_std_findStudentBasicInfoResult" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>学生管理→查找的学生基本信息结果：</title>
                ...
                <td colspan="3" style="vertical-align: top; text-align: left">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="teachedClass" HeaderText="教学班">
                                <ItemStyle Width="70px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="adminClass" HeaderText="行政班">
                                <ItemStyle Width="70px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="currentlyGrade" HeaderText="年级">
                                <ItemStyle Width="40px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="fromArea" HeaderText="来源地区">
                                <ItemStyle Width="120px" />
                            </asp:BoundField>
