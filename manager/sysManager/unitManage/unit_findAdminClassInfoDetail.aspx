<%@ Page Language="C#" AutoEventWireup="true" CodeFile="unit_findAdminClassInfoDetail.aspx.cs" Inherits="manager_sysManager_unitManage_unit_findAdminClassInfoDetail" %>
                ...
                <td colspan="3" style="vertical-align: top; text-align: left">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="adminClassName" HeaderText="行政班名称">
                                <ItemStyle Width="80px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="adminClassCode" HeaderText="行政班编号">
                                <ItemStyle Width="60px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="teachedClass" HeaderText="行政班">
                                <ItemStyle Width="80px" />
                            </asp:BoundField>
