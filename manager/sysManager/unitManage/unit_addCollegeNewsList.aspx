<%@ Page Language="C#" AutoEventWireup="true" CodeFile="unit_addCollegeNewsList.aspx.cs" Inherits="manager_sysManager_unitManage_unit_addCollegeNewsList" %>
...
<%@ Register Src="std_listFoot.ascx" TagName="std_listFoot" TagPrefix="uc3" %>
<%@ Register Src="std_listMain.ascx" TagName="std_listMain" TagPrefix="uc4" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>部门管理→院系新闻管理→编辑院系新闻</title>
    ...
    <div>
        <table style="width: 740px; height: 490px" border="0" cellpadding="0" cellspacing="0" class="css">
            <tr style="height: 59px">
                <td colspan="3">
                    <uc4:std_listMain ID="Std_listMain1" runat="server" />
                </td>
            </tr>
            <tr style="height: 25px">
                <td colspan="3" style="background-image: url(../../../image/system/main_top_bg.gif)">
                    &nbsp;&nbsp; 部门管理→院系新闻管理→编辑院系新闻</td>
            </tr>
            <tr style="height: 356px">
                <td colspan="3" style="background-color: #dee9f9; text-align: center">
                    <table border="1" bordercolordark="#003399" bordercolorlight="#6a82dd" cellpadding="0"
                        ...
                        <tr style="height: 25px">
                            ...
                            <td colspan="3">
                                &nbsp;
                                <asp:TextBox ID="newsTitle" runat="server" Width="289px" BackColor="#DEE9F9" ReadOnly="True"></asp:TextBox>（不超过20个字）<asp:RequiredFieldValidator
                        ...
                        <tr style="color: #000000; height: 100px">
                            ...
                            <td colspan="3">
                                &nbsp;
                                <asp:TextBox ID="newsContent" runat="server" Height="85px" TextMode="MultiLine" Width="580px" BackColor="#DEE9F9" ReadOnly="True"></asp:TextBox>
                        ...
                        <tr style="color: #000000; height: 25px">
                            ...
                            <td colspan="3">
                                &nbsp;
                                <asp:TextBox ID="faceObject" runat="server" Width="330px" BackColor="#DEE9F9" ReadOnly="True"></asp:TextBox>（请简要详尽注明年级，班级，专业）<asp:RequiredFieldValidator
                        ...
                        <tr style="color: #000000; height: 25px">
                            ...
                            <td colspan="3">
                                &nbsp;
                                <asp:DropDownList ID="college" runat="server"  Width="347px" Enabled="False" AutoPostBack="True">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr style="height: 25px">
            ...
            <tr style="height: 50px">
                <td colspan="3">
                    <uc3:std_listFoot ID="Std_listFoot1" runat="server" />
                </td>
            </tr>
        </table>
