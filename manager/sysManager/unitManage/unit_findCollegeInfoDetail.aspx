<%@ Page Language="C#" AutoEventWireup="true" CodeFile="unit_findCollegeInfoDetail.aspx.cs" Inherits="manager_sysManager_unitManage_unit_findCollegeInfoDetail" %>
                ...
                <td colspan="3" style="vertical-align: top; text-align: left">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="collegeCode" HeaderText="学院编号">
                                <ItemStyle Width="60px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="collegeIntroduce" HeaderText="学院简介">
