<%@ Page Language="C#" AutoEventWireup="true" CodeFile="unit_findUnitNewsDetail.aspx.cs" Inherits="manager_sysManager_unitManage_unit_findUnitNewsDetail" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="css" style="width: 740px;
            ...
            <tr style="height: 25px">
                <td colspan="3" style="background-image: url(../../../image/system/main_top_bg.gif)">
                    &nbsp;&nbsp; 部门管理→部门新闻管理→查看部门新闻</td>
            </tr>
            <tr style="height: 25px">
                <td style="width: 245px; vertical-align: top; text-align: left;">
                    &nbsp; 部门：<asp:DropDownList ID="unitName" runat="server" AutoPostBack="True" 
                        Width="191px" OnSelectedIndexChanged="unitName_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
                ...
                <td colspan="3" style="vertical-align: top; text-align: left">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="releaseMan" HeaderText="发布人">
