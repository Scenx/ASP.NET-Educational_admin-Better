<%@ Page Language="C#" AutoEventWireup="true" CodeFile="unit_findSpecialityInfoDetail.aspx.cs" Inherits="manager_sysManager_unitManage_unit_findSpecialityInfoDetail" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>部门管理→专业管理→查看专业</title>
                ...
                <td colspan="3" style="vertical-align: top; text-align: left">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="speciality" HeaderText="专业名称">
                                <ItemStyle Width="100px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="specialityCode" HeaderText="专业编号">
                                <ItemStyle Width="50px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="specialityIntroduce" HeaderText="专业简介">
                                <ItemStyle Width="100px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="collegeName" HeaderText="学院">
                            ...
                            <asp:CommandField EditText="详细信息" HeaderText="详细信息" ShowEditButton="True">
                                <ItemStyle Font-Bold="False" ForeColor="Red" Width="50px" />
                            </asp:CommandField>
