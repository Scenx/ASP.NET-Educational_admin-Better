<%@ Page Language="C#" AutoEventWireup="true" CodeFile="unit_addTeachedClassInfoList.aspx.cs" Inherits="manager_sysManager_unitManage_unit_addTeachedClassInfoList" %>
...
<head runat="server">
    <title>部门管理→教学班信息管理→编辑教学班</title>
                    ...
                    <table border="1" bordercolordark="#003399" bordercolorlight="#6a82dd" cellpadding="0"
                        ...
                        <tr style="height: 25px">
                            <td style="width: 359px">
                                教学班编号：
                                <asp:Label ID="teachedClassCode" runat="server" Text="Label"></asp:Label></td>
                            <td style="width: 284px; color: #000000">
                                教学班名称：
                                <asp:TextBox ID="teachedClassName" runat="server" Width="128px" BackColor="#DEE9F9" ReadOnly="True"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="teachedClassName"
                        ...
                        <tr style="height: 25px">
                            ...
                            <td style="width: 284px">
                                所属专业：<asp:DropDownList ID="speciality" runat="server" Width="107px" Enabled="False">
                                </asp:DropDownList></td>
