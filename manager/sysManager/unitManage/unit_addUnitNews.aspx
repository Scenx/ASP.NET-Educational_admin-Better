<%@ Page Language="C#" AutoEventWireup="true" CodeFile="unit_addUnitNews.aspx.cs" Inherits="manager_sysManager_unitManage_unit_addUnitNews" %>
                ...
                <td colspan="3" rowspan="2" style="vertical-align: top; background-color: #dee9f9; text-align: center">
                    &nbsp;<table border="1" bordercolordark="#003399" bordercolorlight="#6a82dd" cellpadding="0"
                        ...
                        <tr style="color: #000000; height: 25px">
                            ...
                            <td colspan="3">
                                &nbsp;&nbsp;
                                <asp:DropDownList ID="unitName" runat="server" Width="234px">
                                </asp:DropDownList></td>
                        </tr>
                        <tr style="height: 25px">
                            <td style="width: 100px">
                        ...
                        <tr style="height: 25px">
                            <td colspan="4" style="text-align: center">
                                <asp:Button ID="release" runat="server" class="btn3_mouseout" OnClick="release_Click"
