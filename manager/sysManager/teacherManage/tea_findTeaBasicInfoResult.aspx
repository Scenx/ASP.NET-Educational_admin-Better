<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tea_findTeaBasicInfoResult.aspx.cs" Inherits="manager_sysManager_teacherManage_tea_findTeaBasicInfoResult" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>教师管理→查找教师基本信息结果：</title>
                ...
                <td colspan="3" style="vertical-align: top; text-align: left">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="educationalLevel" HeaderText="学历层次">
                                <ItemStyle Width="60px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="graduateCollege" HeaderText="毕业院校">
                                <ItemStyle Width="100px" />
                            </asp:BoundField>
