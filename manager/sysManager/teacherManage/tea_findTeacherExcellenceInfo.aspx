<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tea_findTeacherExcellenceInfo.aspx.cs" Inherits="manager_sysManager_teacherManage_tea_findTeacherExcellenceInfo" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>教师管理→教师在职信息管理→查找教师获奖信息</title>
            ...
            <tr style="height: 465px">
                <td colspan="3" rowspan="2" style="vertical-align: top; background-color: #dee9f9; text-align: center">
                    <table border="1" bordercolordark="#003399" bordercolorlight="#6a82dd" cellpadding="0"
                        ...
                        <tr style="height: 25px">
                            <td style="width: 332px; height: 25px">
                                <asp:CheckBox ID="college1" runat="server" Checked="True" Enabled="False" Text="教师学院：" /><asp:DropDownList
