<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tea_findTeacherUserInfoResult.aspx.cs" Inherits="manager_sysManager_teacherManage_tea_findTeacherUserInfoResult" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title> 教师管理→查找教师用户信息结果：</title>
                ...
                <td colspan="3" style="vertical-align: top; text-align: left">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="pwdProtectQue2" HeaderText="密报问题2">
                                <ItemStyle Width="100px" />
                            </asp:BoundField>
