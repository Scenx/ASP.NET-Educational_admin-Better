<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tea_findTransmitMarkInfoResult.aspx.cs" Inherits="manager_sysManager_teacherManage_tea_findTransmitMarkInfoResult" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>教师管理→查找教师上传成绩信息结果：</title>
            ...
            <tr style="height: 545px">
                <td colspan="3" style="vertical-align: top; text-align: left">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        OnRowEditing="GridView1_RowEditing" PageSize="12" Width="1003px">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="transmitDate" HeaderText="上传时间" >
                                <ItemStyle Width="60px" />
                            </asp:BoundField>
