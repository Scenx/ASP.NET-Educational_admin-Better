<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tea_findTeacherPunishInfoResult.aspx.cs" Inherits="manager_sysManager_teacherManage_tea_findTeacherPunishInfoResult" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>教师管理→查找受过处分的教师信息结果</title>
