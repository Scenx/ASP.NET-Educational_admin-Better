<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sys_examineSuperManagerPopedom.aspx.cs" Inherits="manager_sysManager_systemManage_sys_examineSuperManagerPopedom" %>
            ...
            <tr style="height: 465px">
                <td colspan="3" rowspan="2" style="vertical-align: top; background-color: #dee9f9; text-align: center; width: 740px;">
                    <table style="width: 735px; height: 114px; text-align: left;" border="1" cellpadding="0" cellspacing="0" bordercolordark="#003399" bordercolorlight="#6a82dd" class="css">
                        ...
                        <tr style="height: 25px">
                            <td style="width: 160px" rowspan="8">
                                &nbsp; 超级管理员权限：（超级管理员除了拥有以上所有角色的所有权限外，还拥有如下特有的权限！）</td>
                            <td colspan="2" style="width: 575px">
                                &nbsp;&nbsp;<asp:CheckBox ID="CheckBox93" runat="server" Checked="True" Text="系统参数设置" />&nbsp;
                                <asp:CheckBox ID="CheckBox94" runat="server" Checked="True" Text="查看超级管理员权限" />&nbsp;
                                <asp:CheckBox ID="CheckBox97" runat="server" Checked="True" Text="添加 / 删除 / 查找 / 编辑部门信息" />
                                <asp:CheckBox ID="CheckBox119" runat="server" Checked="True" Text="管理员基本信息" /></td>
                        </tr>
                        <tr style="height: 25px">
                            <td colspan="2" style="width: 575px">
                                &nbsp;
                                <asp:CheckBox ID="CheckBox98" runat="server" Checked="True" Text="添加 / 删除 / 查找 / 编辑院系信息" />&nbsp;
                                <asp:CheckBox ID="CheckBox99" runat="server" Checked="True" Text="添加 / 删除 / 查找 / 编辑学院专业信息" />&nbsp;
                                <asp:CheckBox ID="CheckBox120" runat="server" Checked="True" Text="密码保护" /></td>
                        </tr>
                        <tr style="height: 25px">
                            <td colspan="2" style="width: 575px">
                                &nbsp;
                                <asp:CheckBox ID="CheckBox100" runat="server" Checked="True" Text="添加 / 删除 / 查找 / 编辑教学办信息" />&nbsp;
                                <asp:CheckBox ID="CheckBox101" runat="server" Checked="True" Text="添加 / 删除 / 查找 / 编辑行政班信息" />&nbsp;
                                <asp:CheckBox ID="CheckBox121" runat="server" Checked="True" Text="修改密码" /></td>
                        </tr>
                        <tr style="height: 25px">
                            <td colspan="2" style="width: 575px">
                                &nbsp;
                                <asp:CheckBox ID="CheckBox102" runat="server" Checked="True" Text="各院系贫困生信息统计" />&nbsp;
                                <asp:CheckBox ID="CheckBox103" runat="server" Checked="True" Text="各院系贫奖学金信息统计" />&nbsp;
                                <asp:CheckBox ID="CheckBox104" runat="server" Checked="True" Text="各院系受处分信息统计" /></td>
                        </tr>
                        <tr style="height: 25px">
                            <td colspan="2" style="width: 575px">
                                &nbsp;
                                <asp:CheckBox ID="CheckBox105" runat="server" Checked="True" Text="各院系年级成绩排名统计" />&nbsp;
                                <asp:CheckBox ID="CheckBox106" runat="server" Checked="True" Text="各院系等级考试成绩统计" />&nbsp;
                                <asp:CheckBox ID="CheckBox107" runat="server" Checked="True" Text="各院系贫取消学位信息统计" /></td>
                        </tr>
                        <tr style="height: 25px">
                            <td colspan="2" style="width: 575px">
                                &nbsp;
                                <asp:CheckBox ID="CheckBox108" runat="server" Checked="True" Text="各院系教师获奖信息统计" />
                                &nbsp;
                                <asp:CheckBox ID="CheckBox109" runat="server" Checked="True" Text="各院系教师处分信息统计" /></td>
                        </tr>
                        <tr style="height: 25px">
                            <td colspan="2" style="width: 575px">
                                &nbsp;&nbsp;
                                <asp:CheckBox ID="CheckBox110" runat="server" Checked="True" Text="添加 / 删除 / 查找 / 编辑系统管理员" />&nbsp;
                                <asp:CheckBox ID="CheckBox123" runat="server" Checked="True" Text="添加 / 删除 / 查找 / 编辑部门管理员" /></td>
                        </tr>
                        <tr style="height: 25px">
                            <td colspan="2" style="width: 575px">
                                &nbsp;
                                <asp:CheckBox ID="CheckBox124" runat="server" Checked="True" Text="添加 / 删除 / 查找 / 编辑院系管理员" />&nbsp;
                                <asp:CheckBox ID="CheckBox122" runat="server" Checked="True" Text="退出系统" />&nbsp;
                            </td>
                        </tr>
                    </table>
                </td>
